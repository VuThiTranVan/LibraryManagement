...
public class BorrowedBookDaoImpl extends AbstractDao<Integer, Borroweds> implements BorrowedBookDao {
	...
	@SuppressWarnings("unchecked")
	@Override
	public Borroweds update(Borroweds mBorrowed) throws ParseException {
	...
	@Override
	public BorrowedDetails updateBorrowedDetails(BorrowedDetails mBorrowedDetails) throws ParseException {
