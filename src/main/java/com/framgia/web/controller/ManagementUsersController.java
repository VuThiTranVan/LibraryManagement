...
public class ManagementUsersController {
	...
	@ResponseBody
	public int delLogicUser(@PathVariable("id") String idUser, @RequestParam(value = "dateUpd") String dateUpd) {
		int result = 0;

		result = managementUsersService.delLogicUser(idUser, getUserName(), dateUpd);
